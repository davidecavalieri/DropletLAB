...
function [ac,bc,cc] = SRK_abc(Tc,Pc,omega)

%%%%%%%%%%%%%%%%%%%%%%%%%%% DESCRIPTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SRK_abc calculates the non-ideal parameters of the Soave-Redlick-Kwong EoS
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% implentare l'if ..
cc =  0.48508 + 1.555171.*omega - 0.15613*omega.^2;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
bc =  (k1 * R0.*Tc)./(Pc);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ac =  (k2 * (R0^2).*(Tc.^2))./(Pc);
