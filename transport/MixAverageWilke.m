...
function [Di_mix] = MixAverageWilke(Xi,Dij,Yi)

%%%%%%%%%%%%%%%%%%%%%%%%%%% DESCRIPTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MixAverageWilke calculates the mixture diffusion coeffiecient for species k
% into the mixture, using the Wilke's formulation.
